...
FixedFilterWidget::FixedFilterWidget() {
	...
	addParam(createParam<Davies1900hBlackKnob>(Vec(20, 50), module, FixedFilter::EQ1, -12, 12.0, 0));
	addParam(createParam<Davies1900hBlackKnob>(Vec(20, 110), module, FixedFilter::EQ2, -12, 12.0, 0.0));
	addParam(createParam<Davies1900hBlackKnob>(Vec(20, 170), module, FixedFilter::EQ3, -12, 12.0, 0.0));
	addParam(createParam<Davies1900hBlackKnob>(Vec(20, 230), module, FixedFilter::EQ4, -12, 12.0, 0.0));
	 

	addParam(createParam<Davies1900hBlackKnob>(Vec(80, 50), module, FixedFilter::EQ1, -12, 12.0, 0.0));
	addParam(createParam<Davies1900hBlackKnob>(Vec(80, 110), module, FixedFilter::EQ2, -12, 12.0, 0.0));
	addParam(createParam<Davies1900hBlackKnob>(Vec(80, 170), module, FixedFilter::EQ3, -12, 12.0, 0.0));
	addParam(createParam<Davies1900hBlackKnob>(Vec(80, 230), module, FixedFilter::EQ4, -12, 12.0, 0.0));
